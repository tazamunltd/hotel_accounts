...
class MonthlyGroupsCharts(models.Model):
    ...
    def action_run_process_by_monthly_groups_charts(self):
        ...
        if self.env.context.get('filtered_date_range'):
            ...
            return {
                ...
                'views': [
                    (self.env.ref('hotel_management.view_monthly_groups_charts_tree').id, 'tree'),
                    (self.env.ref('hotel_management.view_monthly_groups_charts_graph').id, 'graph'),
                    (self.env.ref('hotel_management.view_monthly_groups_charts_pivot').id, 'pivot'),
                ],
                'target': 'current',
            }
        else:
    ...
    def run_process_by_monthly_groups_charts(self, from_date = None, to_date = None):
        ...
        _logger.debug("Started run_process_by_monthly_groups_charts")
...
ORDER BY
    ...
    , fr.group_booking_name;
        ...
        _logger.debug("Completed run_process_by_monthly_groups_charts")
