...
class RoomResultByRoomType(models.Model):
    ...
    def action_run_process_by_room_type(self):
        ...
        if self.env.context.get('filtered_date_range'):
            ...
            return {
                ...
                'views': [
                    (self.env.ref(
                        'hotel_management.view_room_result_by_room_type_tree').id, 'tree'),
                    (self.env.ref(
                        'hotel_management.view_room_result_by_room_type_pivot').id, 'pivot'),
                    (self.env.ref(
                        'hotel_management.view_room_result_by_room_type_graph').id, 'graph'),
                ],
                'target': 'current',
            }
        else:
    ...
    def run_process_by_room_type(self,from_date = None, to_date = None):
        ...
        _logger.debug("Started run_process_by_room_type")
        # SQL Query (modified)
...
ORDER BY
  ...
  fr.room_type_name;
        ...
        _logger.debug("Completed run_process_by_room_type")