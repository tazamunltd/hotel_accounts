    ...
    def action_run_process_by_region(self):
        ...
        if self.env.context.get('filtered_date_range'):
            ...
            return {
                ...
                'views': [
                    (self.env.ref(
                        'hotel_management.yearly_geographical_chart_tree_view').id, 'tree'),
                    (self.env.ref(
                        'hotel_management.yearly_geographical_chart_graph_view').id, 'graph'),
                    (self.env.ref(
                        'hotel_management.yearly_geographical_chart_pivot_view').id, 'pivot'),
                ],
                'target': 'current',
            }
        else:
...
# ),
    ...
    def run_process_by_region(self,from_date = None, to_date = None):
        ...
        _logger.debug("Started run_process_by_Region")
...
"""
        ...
        _logger.debug("Completed run_process_by_Region")