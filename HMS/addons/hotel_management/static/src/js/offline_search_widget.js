...
export class OfflineSearchWidget extends Component {
    static template = "hotel_management.OfflineSearchWidget";
    static components = {};
    static props = {
            ...
            if (dataJSON && this.isExistingBooking()) {
                ...
                if (this.state.checkInDate && this.state.checkOutDate) {
                    if (this.state.checkInDate !== this.state.checkOutDate) {
                        ...
                        this.state.checkOutDate = checkOut.toISOString().split('T')[0]; // Keep YYYY-MM-DD format
                    }
                }
...
// Define the template
OfflineSearchWidget.template = "hotel_management.OfflineSearchWidget";