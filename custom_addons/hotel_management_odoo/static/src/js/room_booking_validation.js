        ...
        input.addEventListener("change", function (e) {
            ...
            setTimeout(function() {
                ...
                message.textContent = _t(
                  "Do you want to search rooms for count %(count)s?",
                  { count: newValue }
                );
...
// odoo.define(
//   "hotel_management_odoo.room_booking_validation",
//   function (require) {
//     "use strict";
...
//       input.__rcp_old = parseInt(input.value || "0", 10);
//       console.log(
//         "🏨 room_count handler attached (old=" + input.__rcp_old + ")"
//       );
...
//           dialogOverlay.style.justifyContent = "center";
//           dialogOverlay.style.zIndex = "9999";
//           dialogOverlay.id = "room-booking-dialog";
...
//           // Create message (translated with dynamic value)
//           const message = document.createElement("p");
//           message.style.margin = "0 0 25px";
//           message.style.color = "#666";
//           message.style.fontSize = "16px";
//           message.textContent = _t(
//             "Do you want to search rooms for count %s?"
//           ).replace("%s", newValue);
