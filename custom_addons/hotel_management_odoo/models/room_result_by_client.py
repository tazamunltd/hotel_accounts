...
#
            # # Batch create after 500 records (or another suitable batch size)
            # if len(records_to_create) >= 50:
            #     self.create(records_to_create)
            #     _logger.info(f"{len(records_to_create)} records created")
            #     records_to_create = []
        ...
        # if records_to_create:
        #     self.create(records_to_create)
        #     _logger.info(f"{len(records_to_create)} remaining records created")
        #
        _logger.info("Completed run_process")

    # def update_or_create_result(self, result):
    #     """Update or create the result record."""
    #     print('line 257:', result)
    ...
    #         'client_id': result[3],
    #         'expected_inhouse': result[9],
    #         # Include other fields similar to the working example
    #     }
    #
    #     if existing_record:
    ...
    # def create_new_result(self, result):
    #     """Create a new record."""
    #     print('line 313')
    #     data = {
    #         'report_date': result[0],
    ...
    #         'client_id': result[3],
    #         'expected_inhouse': result[9],
    #         # Add other fields as needed based on your query result
    #     }
    #     print('line 321')
    #     self.create(data)
    #     print('line 323')